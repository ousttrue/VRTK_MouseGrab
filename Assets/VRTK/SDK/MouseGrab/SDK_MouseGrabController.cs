...
namespace VRTK
{
    ...
    /// <summary>
    /// The MouseGrab Controller SDK script provides functions to help simulate VR controllers.
    /// </summary>
    [SDK_Description(typeof(SDK_MouseGrabSystem))]
    public class SDK_MouseGrabController : SDK_BaseController
    {
        protected SDK_ControllerMouseGrab rightController;
        protected SDK_ControllerMouseGrab leftController;
        ...
        public override GameObject GetControllerModel(ControllerHand hand)
        {
            ...
            GameObject simPlayer = SDK_InputMouseGrab.FindInScene();
            if (simPlayer != null)
            {
                switch (hand)
                {
        ...
        protected virtual void SetupPlayer()
        {
            if (rightController == null || leftController == null)
            {
                ...
                if (simPlayer != null)
                {
                    rightController = (rightController == null ? simPlayer.transform.Find(RIGHT_HAND_CONTROLLER_NAME).GetComponent<SDK_ControllerMouseGrab>() : rightController);
                    leftController = (leftController == null ? simPlayer.transform.Find(LEFT_HAND_CONTROLLER_NAME).GetComponent<SDK_ControllerMouseGrab>() : leftController);
                }
            }
        }
